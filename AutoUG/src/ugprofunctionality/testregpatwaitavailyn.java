...
public class testregpatwaitavailyn {

	static String  FreebtnPatfamname1;
	static String  FreebtnPatGivenName1;
	static String selapntmnt;
	public static Xls_Reader reader;
	static String  Selschforwaitinglist;
	static WebDriver driver; 

	public static void main(String[] args) throws InterruptedException {
		reader = new Xls_Reader("C:\\Users\\akhosla\\Documents\\regexcelsheet.xlsx");
		FreebtnPatfamname1 = reader.getCellData("reg3", "Freebtn-Patientfamname", 2);
		FreebtnPatGivenName1 = reader.getCellData("reg3", "Freebtn-PatientGivenName ", 2);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//input[@title='Family name' and @id='sFamilyname']")).sendKeys(FreebtnPatfamname1);
		Thread.sleep(3000);
		// driver.findElement(By.xpath("//input[@title='Family name' and @id='sFamilyname']")).sendKeys(Patintfamname);

		driver.findElement(By.xpath("//td[@class='rowInput']//input[@name='sGivenname' and @id='sGivenname']")).sendKeys(FreebtnPatGivenName1);
		Thread.sleep(3000);
