...
public class updateexistingreport2
{
	...
	public static String SelRepFunction2;
	public static String SelReportAftrFxn2;
	
	public static void reportupdate2(WebDriver driver) throws InterruptedException
	{
		...
		SelRepFunction2	=reader.getCellData("reg6", "SelReportFxn2", 2);
		SelReportAftrFxn2	=reader.getCellData("reg6", "SelReportAfterFxn2", 2);
		...
		nreport.selectByVisibleText(SelRepFunction2); 
		Thread.sleep(5000);
		Select nreport1=new Select(driver.findElement(By.xpath("//select[@id='lstReport']")));
		nreport1.selectByVisibleText(SelReportAftrFxn2);
		Thread.sleep(4000);
