...
static String UsergroupNa;
	...
	public static void listrefY(WebDriver driver) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//input[@id='txtReferralListInUseY']")).click(); //clicking on the yes waiting list radio btn
			...
			// Clicking on the schedule setup icon to see waiting list request tab is disabled or not.
				...
				driver.findElement(By.xpath("//div[@class='buttonFloatLeft']//img[@id='scheduleButton']")).click();// clicking on Schedule button-Schedule setup.
				 ...
				 // here waiting list button should be enable.
				  ...
				  public static void listrefN(WebDriver driver) throws InterruptedException
					{
					  driver.findElement(By.xpath("//input[@id='txtReferralListInUseN']")).click(); //clicking on the No waiting list radio btn.
